...
def get_selected_row(event): #the 'event' parameter is fixed for this function
    ...
    selected_tuple = list1.get(index) # this will get the tuple with index[0] from the listbox
    e1.delete(0,END)
...
list1.bind('<<ListboxSelect>>',get_selected_row) # this will apply a specific 'function' to a certain 'event'.
